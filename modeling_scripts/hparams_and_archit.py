...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov  4 15:06:41 2019
...
class Hyperparameters(object):
  ...
  def __init__(self, *unused_args, **init_hparams): # optional args and kwargs
    ...
    unknown_params = set(init_hparams) - set(Hyperparameters._defaults) # difference b/w
    if unknown_params:
      raise ValueError('Unknown hyperparameters: %s' % unknown_params)
    self.update(Hyperparameters._defaults)
    self.update(init_hparams)

  def update(self, dikt, **kwargs): # optional kwargs
